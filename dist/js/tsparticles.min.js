  ...
  return (function (t) {
    ...
    2: function (t, i, e) {
      ...
      e.r(i),
        ...
        e.d(i, 'ThemeMode', function () {
          return b
        }),
        e.d(i, 'AnimationStatus', function () {
          return r
        }),
        ...
        e.d(i, 'AbsorberClickMode', function () {
          return Fi
        }),
        e.d(i, 'EmitterClickMode', function () {
          return Bi
        }),
        e.d(i, 'InlineArrangement', function () {
          return Ji
        }),
        e.d(i, 'MoveType', function () {
          return Qi
        }),
        e.d(i, 'Type', function () {
          return Yi
        }),
        e.d(i, 'CanvasUtils', function () {
          return O
        }),
        e.d(i, 'ColorUtils', function () {
          return D
        }),
        e.d(i, 'Constants', function () {
          return I
        }),
        e.d(i, 'Utils', function () {
          return k
        }),
      ...
      Object.create
      var s, n, a, r, l, c, d, h, u, v, p, y, m, f, g, b
      Object.create
      class w {
        getSidesCount() {
          return 4
      ...
      class x {
        ...
        static getValue(t) {
          ...
          return e ? x.randomInRange(o, t.value) : t.value
        }
        ...
        static getDistance(t, i) {
          return x.getDistances(t, i).distance
        }
      ...
      class k {
        ...
        static itemFromArray(t, i, e = !0) {
          return t[void 0 !== i && e ? i % t.length : k.arrayRandomIndex(t)]
        }
        static isPointInside(t, i, e, o) {
          return k.areBoundsInside(
            k.calculateBounds(t, null != e ? e : 0),
            i,
            o
          )
        }
        ...
        static downloadSvgImage(t) {
          return o(this, void 0, void 0, function* () {
            ...
            if ('svg' !== i.type) return k.loadImage(t)
        ...
        static isDivModeEnabled(t, i) {
          return i instanceof Array
            ? !!i.find((i) => i.enable && k.isInArray(t, i.mode))
            : k.isInArray(t, i.mode)
        }
        static divModeExecute(t, i, e) {
          if (i instanceof Array)
            for (const o of i) {
              const i = o.mode
              o.enable && k.isInArray(t, i) && k.singleDivModeExecute(o, e)
            }
          else {
            const o = i.mode
            i.enable && k.isInArray(t, o) && k.singleDivModeExecute(i, e)
          }
        }
        ...
        static divMode(t, i) {
          if (i && t)
            return t instanceof Array
              ? t.find((t) => k.checkSelector(i, t.selectors))
              : k.checkSelector(i, t.selectors)
              ? t
              : void 0
        }
        static circleBounceDataFromParticle(t) {
          return {
            ...
            velocity: t.velocity,
            factor: {
              horizontal: x.getValue(t.particlesOptions.bounce.horizontal),
              vertical: x.getValue(t.particlesOptions.bounce.vertical),
            },
          }
        }
        static circleBounce(t, i) {
          ...
          if (e * (n.x - s.x) + o * (n.y - s.y) >= 0) {
            const e = -Math.atan2(n.y - s.y, n.x - s.x),
              o = t.radius,
              a = i.radius,
              r = x.rotateVelocity(t.velocity, e),
              l = x.rotateVelocity(i.velocity, e),
              c = x.collisionVelocity(r, l, o, a),
              d = x.collisionVelocity(l, r, o, a),
              h = x.rotateVelocity(c, -e),
              u = x.rotateVelocity(d, -e)
            ;(t.velocity.horizontal = h.horizontal * t.factor.horizontal),
              (t.velocity.vertical = h.vertical * t.factor.vertical),
              (i.velocity.horizontal = u.horizontal * i.factor.horizontal),
              (i.velocity.vertical = u.vertical * i.factor.vertical)
          }
        }
        static rectBounce(t, i) {
          const e = t.getPosition(),
            o = t.getRadius(),
            s = k.calculateBounds(e, o),
            n = k.rectSideBounce(
      ...
      class z {
        ...
        init(t) {
          ...
          return o(this, void 0, void 0, function* () {
            const e = t.options
            if (
              k.isInArray(a.char, e.particles.shape.type) ||
              k.isInArray(a.character, e.particles.shape.type)
            ) {
              const t =
                null !== (i = e.particles.shape.options[a.character]) &&
                void 0 !== i
                  ? i
                  : e.particles.shape.options[a.char]
              if (t instanceof Array) for (const i of t) yield k.loadFont(i)
              else void 0 !== t && (yield k.loadFont(t))
            }
          })
        }
        draw(t, i, e) {
          ...
          void 0 === n.text &&
            (n.text =
              s instanceof Array ? k.itemFromArray(s, i.randomIndexData) : s)
          const a = n.text,
            r = o.style,
            l = o.weight,
            c = 2 * Math.round(e),
      ...
      class P {
        ...
        init(t) {
          ...
          return o(this, void 0, void 0, function* () {
            ...
            if (!k.isInArray(a.image, e.type) && !k.isInArray(a.images, e.type))
              return
            const o =
              null !== (i = e.options[a.images]) && void 0 !== i
                ? i
                : e.options[a.image]
          ...
          return o(this, void 0, void 0, function* () {
            try {
              const e = i.replaceColor
                ? yield k.downloadSvgImage(i.src)
                : yield k.loadImage(i.src)
              this.addImage(t, e)
            } catch (t) {
      ...
      class M {
        static getPlugin(t) {
          return M.plugins.find((i) => i.id === t)
        }
        static addPlugin(t) {
          M.getPlugin(t.id) || M.plugins.push(t)
        }
        ...
        static loadOptions(t, i) {
          for (const e of M.plugins) e.loadOptions(t, i)
        }
        static getPreset(t) {
          return M.presets.get(t)
        }
        static addPreset(t, i) {
          M.getPreset(t) || M.presets.set(t, i)
        }
        static addShapeDrawer(t, i) {
          M.getShapeDrawer(t) || M.drawers.set(t, i)
        }
        static getShapeDrawer(t) {
          return M.drawers.get(t)
        }
        static getSupportedShapes() {
          return M.drawers.keys()
        }
      }
      ...
      class D {
        static colorToRgb(t, i, e = !0) {
          ...
          if ('string' == typeof a.value)
            r =
              a.value === I.randomColorValue
                ? D.getRandomRgbColor()
                : D.stringToRgb(a.value)
          else if (a.value instanceof Array) {
            const t = k.itemFromArray(a.value, i, e)
            ...
            if (void 0 !== i.r) r = i
              ...
              if (void 0 !== i.h && void 0 !== i.l) r = D.hslToRgb(i)
              else {
                const i = null !== (n = t.hsv) && void 0 !== n ? n : a.value
                void 0 !== i.h && void 0 !== i.v && (r = D.hsvToRgb(i))
              }
            }
          }
          return r
        ...
        static colorToHsl(t, i, e = !0) {
          const o = D.colorToRgb(t, i, e)
          return void 0 !== o ? D.rgbToHsl(o) : o
        }
        static rgbToHsl(t) {
          const i = t.r / 255,
            e = t.g / 255,
        ...
        static stringToAlpha(t) {
          var i
          return null === (i = D.stringToRgba(t)) || void 0 === i ? void 0 : i.a
        }
        static stringToRgb(t) {
          return D.stringToRgba(t)
        }
        static hslToRgb(t) {
          const i = { b: 0, g: 0, r: 0 },
          ...
          if (0 === e.s) (i.b = e.l), (i.g = e.l), (i.r = e.l)
            ...
            const t = e.l < 0.5 ? e.l * (1 + e.s) : e.l + e.s - e.l * e.s,
              o = 2 * e.l - t
            ;(i.r = D.hue2rgb(o, t, e.h + 1 / 3)),
              (i.g = D.hue2rgb(o, t, e.h)),
              (i.b = D.hue2rgb(o, t, e.h - 1 / 3))
          }
          return (
        ...
        static rgbaToHsva(t) {
          const i = D.rgbToHsv(t)
          return { a: t.a, h: i.h, s: i.s, v: i.v }
        }
        static getRandomRgbColor(t) {
          const i = null != t ? t : 0
          return {
            b: Math.floor(x.randomInRange(i, 256)),
            g: Math.floor(x.randomInRange(i, 256)),
            r: Math.floor(x.randomInRange(i, 256)),
          }
        }
        ...
        static getStyleFromHsv(t, i) {
          return D.getStyleFromHsl(D.hsvToHsl(t), i)
        }
        static mix(t, i, e, o) {
          let s = t,
            n = i
          return (
            void 0 === s.r && (s = D.hslToRgb(t)),
            void 0 === n.r && (n = D.hslToRgb(i)),
            {
              b: x.mix(s.b, n.b, e, o),
              g: x.mix(s.g, n.g, e, o),
              r: x.mix(s.r, n.r, e, o),
        ...
        static replaceColorSvg(t, i, e) {
          ...
          return t.svgData.replace(/#([0-9A-F]{3,6})/gi, () =>
            D.getStyleFromHsl(i, e)
          )
        }
        static getLinkColor(t, i, e) {
          var o, s
          if (e === I.randomColorValue) return D.getRandomRgbColor()
          if ('mid' !== e) return e
          {
            const e =
              ...
              n =
                ...
                void 0 !== s
                  ...
                  ? void 0
                  : i.getStrokeColor()
            if (e && n && i) return D.mix(e, n, t.getRadius(), i.getRadius())
            {
              const t = null != e ? e : n
              if (t) return D.hslToRgb(t)
            }
          }
        }
        static getLinkRandomColor(t, i, e) {
          const o = 'string' == typeof t ? t : t.value
          return o === I.randomColorValue
            ? e
              ? D.colorToRgb({ value: o })
              : i
              ? I.randomColorValue
              : I.midColorValue
            : D.colorToRgb({ value: o })
      ...
      class O {
        ...
        static drawLinkLine(t, i, e, o, s, n, a, r, l, c, d, h) {
          let u = !1
          if (x.getDistance(e, o) <= s) O.drawLine(t, e, o), (u = !0)
          else if (a) {
            let i, a
            const r = { x: o.x - n.width, y: o.y },
              { dx: l, dy: c, distance: d } = x.getDistances(e, r)
            if (d <= s) {
              const t = e.y - (c / l) * e.x
              ;(i = { x: 0, y: t }), (a = { x: n.width, y: t })
            } else {
              const t = { x: o.x, y: o.y - n.height },
                { dx: r, dy: l, distance: c } = x.getDistances(e, t)
              if (c <= s) {
            ...
            i && a && (O.drawLine(t, e, i), O.drawLine(t, o, a), (u = !0))
          }
          if (u) {
            if (
              ((t.lineWidth = i),
              r && (t.globalCompositeOperation = l),
              (t.strokeStyle = D.getStyleFromRgb(c, d)),
              h.enable)
            ) {
              const i = D.colorToRgb(h.color)
              i &&
                ((t.shadowBlur = h.blur),
                (t.shadowColor = D.getStyleFromRgb(i)))
            }
            t.stroke()
          }
        }
        static drawLinkTriangle(t, i, e, o, s, n, a, r, l) {
          O.drawTriangle(t, e, o, s),
            (t.lineWidth = i),
            n && (t.globalCompositeOperation = a),
            (t.fillStyle = D.getStyleFromRgb(r, l)),
            t.fill()
        }
        ...
        static gradient(t, i, e, o) {
          ...
          const r = i.getPosition(),
            l = e.getPosition(),
            c = D.mix(n, a, i.getRadius(), e.getRadius()),
            d = t.createLinearGradient(r.x, r.y, l.x, l.y)
          return (
            d.addColorStop(0, D.getStyleFromHsl(n, o)),
            d.addColorStop(s > 1 ? 1 : s, D.getStyleFromRgb(c, o)),
            d.addColorStop(1, D.getStyleFromHsl(a, o)),
            d
          )
        }
        static drawGrabLine(t, i, e, o, s, n) {
          t.save(),
            O.drawLine(t, e, o),
            (t.strokeStyle = D.getStyleFromRgb(s, n)),
            (t.lineWidth = i),
            t.stroke(),
            t.restore()
        }
        static drawLight(t, i, e) {
          ...
          a.start &&
            a.stop &&
            (s.addColorStop(0, D.getStyleFromRgb(a.start)),
            s.addColorStop(1, D.getStyleFromRgb(a.stop)),
            (i.fillStyle = s),
            i.fill())
        }
        ...
        static drawParticle(t, i, e, o, s, n, a, r, l, c, d) {
          ...
          const u =
            e.rotate.value + (e.particlesOptions.rotate.path ? e.pathAngle : 0)
          0 !== u && i.rotate(u), a && (i.globalCompositeOperation = r)
          const v = e.shadowColor
          d.enable &&
            v &&
            ((i.shadowBlur = d.blur),
            (i.shadowColor = D.getStyleFromRgb(v)),
          ...
          ;(i.lineWidth = e.strokeWidth),
            ...
            O.drawShapeAfterEffect(t, i, e, l, c, o),
            i.restore()
        }
      ...
      class L {
        ...
        init() {
          ...
          v &&
            (u.backgroundMode.enable
              ? ((this.originalStyle = k.deepExtend({}, v.style)),
          ...
          const p = u.backgroundMask.cover,
            ...
            f = D.colorToRgb(y)
          ;(this.coverColor =
            void 0 !== f ? { r: f.r, g: f.g, b: f.b, a: p.opacity } : void 0),
            (this.trailFillColor = D.colorToRgb(m.fillColor)),
            this.initBackground(),
            this.paint()
        }
        loadCanvas(t, i) {
          var e
          t.className || (t.className = I.canvasClass),
            this.generatedCanvas &&
              (null === (e = this.element) || void 0 === e || e.remove()),
            (this.generatedCanvas = null != i ? i : this.generatedCanvas),
            (this.element = t),
            (this.originalStyle = k.deepExtend({}, this.element.style)),
        ...
        destroy() {
          ...
          this.generatedCanvas &&
            ...
            this.context && O.clear(this.context, this.size)
        }
        resize() {
          this.element &&
        ...
        paint() {
          ...
          this.context &&
            ...
            this.coverColor
              ? (O.clear(this.context, this.size),
                this.paintBase(
                  D.getStyleFromRgb(this.coverColor, this.coverColor.a)
                ))
              : this.paintBase())
        }
        clear() {
          ...
          t.backgroundMask.enable
            ...
            ? this.paintBase(
                D.getStyleFromRgb(this.trailFillColor, 1 / i.length)
              )
            : this.context && O.clear(this.context, this.size)
        }
        windowResize() {
          ...
          ;(t.canvas.size.width = this.element.offsetWidth * e),
            (t.canvas.size.height = this.element.offsetHeight * e),
        ...
        drawParticleShadow(t, i) {
          this.context &&
            O.drawParticleShadow(this.container, this.context, t, i)
        }
        ...
        drawParticle(t, i) {
          ...
          if (
            !1 ===
              (null === (e = t.image) || void 0 === e ? void 0 : e.loaded) ||
            t.spawning ||
            t.destroyed
          )
            return
          ...
          const l = this.container,
            c = l.options,
            d = l.particles,
            h = t.particlesOptions,
            u = h.twinkle.particles,
            v = u.frequency,
            p = D.colorToRgb(u.color),
            y = u.enable && Math.random() < v,
            m = t.getRadius(),
            f = y
              ? u.opacity
              ...
              ? s
              : t.opacity.value,
            g = t.infecter.infectionStage,
            b = c.infection.stages,
            w = void 0 !== g ? b[g].color : void 0,
            x = D.colorToRgb(w),
            k =
              y && void 0 !== p
                ? p
            ...
            z =
              y && void 0 !== p
                ...
                ? D.hslToRgb(r)
                : void 0,
            P = void 0 !== k ? D.getStyleFromRgb(k, f) : void 0
          if (!this.context || (!P && !z)) return
          const M =
            void 0 !== z
              ? D.getStyleFromRgb(
                  z,
                  null !== (n = t.stroke.opacity) && void 0 !== n ? n : f
                )
              : P
          if (t.links.length > 0) {
            this.context.save()
            const i = t.links.filter(
              (i) =>
                l.particles.getLinkFrequency(t, i.destination) <=
                h.links.frequency
            )
            for (const e of i) {
              const o = e.destination
              if (h.links.triangles.enable) {
                const s = i.map((t) => t.destination),
                  n = o.links.filter(
                    (t) =>
                      l.particles.getLinkFrequency(o, t.destination) <=
                        o.particlesOptions.links.frequency &&
                      s.indexOf(t.destination) >= 0
                  )
                if (n.length)
                  for (const i of n) {
                    const s = i.destination
                    d.getTriangleFrequency(t, o, s) >
                      h.links.triangles.frequency ||
                      this.drawLinkTriangle(t, e, i)
                  }
              }
        ...
        initBackground() {
          ...
          const e = i.style
          if (t.color) {
            const i = D.colorToRgb(t.color)
            i && (e.backgroundColor = D.getStyleFromRgb(i, t.opacity))
          }
      ...
      class H {
        ...
        updateLife(t) {
          ...
          if (
            ...
            ;(i.position.x = x.randomInRange(0, t.width)),
              (i.position.y = x.randomInRange(0, t.height)),
              (i.spawning = !0),
              (i.lifeDelayTime = 0),
              (i.lifeTime = 0)
            const e = i.particlesOptions.life
            ;(i.lifeDelay = 1e3 * x.getValue(e.delay)),
              (i.lifeDuration = 1e3 * x.getValue(e.duration))
          }
        }
        updateOpacity(t) {
          var i, e
          const o = this.particle
          if (o.particlesOptions.opacity.animation.enable) {
            switch (o.opacity.status) {
              case r.increasing:
                o.opacity.value >= o.particlesOptions.opacity.value
                  ? (o.opacity.status = r.decreasing)
                  : (o.opacity.value +=
              ...
              case r.decreasing:
                o.opacity.value <=
                o.particlesOptions.opacity.animation.minimumValue
                  ? (o.opacity.status = r.increasing)
                  : (o.opacity.value -=
                      (null !== (e = o.opacity.velocity) && void 0 !== e
                        ? e
                        : 0) * t.factor)
            }
            o.opacity.value < 0 && (o.opacity.value = 0)
          }
        }
        updateSize(t) {
          var i, e
          const o = this.container,
            ...
            c =
              null !== (e = s.sizeValue) && void 0 !== e
                ? e
                : o.retina.sizeValue,
            d = n.minimumValue * o.retina.pixelRatio
          if (n.enable) {
            switch (s.size.status) {
              case r.increasing:
                s.size.value >= c
                  ? (s.size.status = r.decreasing)
                  : (s.size.value += a)
                break
              case r.decreasing:
                s.size.value <= d
                  ? (s.size.status = r.increasing)
                  : (s.size.value -= a)
            }
            switch (n.destroy) {
              case l.max:
                s.size.value >= c && s.destroy()
                break
              case l.min:
                s.size.value <= d && s.destroy()
            }
            s.size.value < 0 && !s.destroyed && (s.size.value = 0)
          }
        }
        updateAngle(t) {
          var i
          const e = this.particle,
            ...
            a = 2 * Math.PI
          if (o.path)
            e.pathAngle = Math.atan2(e.velocity.vertical, e.velocity.horizontal)
          else if (s.enable)
        ...
        updateOutMode(t, i, e) {
          const o = this.container,
            n = this.particle,
            a = n.particlesOptions.move.gravity
          switch (i) {
            case c.bounce:
            case c.bounceVertical:
            case c.bounceHorizontal:
            case 'bounceVertical':
            case 'bounceHorizontal':
              this.updateBounce(t, e, i)
              break
            case c.destroy:
              k.isPointInside(n.position, o.canvas.size, n.getRadius(), e) ||
                o.particles.remove(n)
              break
            case c.out:
              k.isPointInside(n.position, o.canvas.size, n.getRadius(), e) ||
              ...
              break
            case c.none:
              if (n.particlesOptions.move.distance) return
              if (a.enable) {
                const t = n.position
                ;((a.acceleration >= 0 &&
                  t.y > o.canvas.size.height &&
                  e === s.bottom) ||
                  (a.acceleration < 0 && t.y < 0 && e === s.top)) &&
                  o.particles.remove(n)
              } else
                k.isPointInside(n.position, o.canvas.size, n.getRadius(), e) ||
                  o.particles.remove(n)
        ...
        fixOutOfCanvasPosition(t) {
          const i = this.container,
            ...
            r = e.getRadius(),
            l = k.calculateBounds(e.position, r)
        ...
        updateBounce(t, i, e) {
          ...
          for (const [, e] of o.plugins)
            if (
              (void 0 !== e.particleBounce && (a = e.particleBounce(n, t, i)),
              a)
            )
              break
          if (a) return
          const r = n.getPosition(),
            l = n.offset,
            d = n.getRadius(),
            h = k.calculateBounds(r, d),
            u = o.canvas.size
          if (
            e === c.bounce ||
            e === c.bounceHorizontal ||
            'bounceHorizontal' === e
          ) {
            const t = n.velocity.horizontal
            let e = !1
            if (
              (i === s.right && h.right >= u.width && t > 0) ||
              (i === s.left && h.left <= 0 && t < 0)
            ) {
              const t = x.getValue(n.particlesOptions.bounce.horizontal)
              ;(n.velocity.horizontal *= -t), (e = !0)
            }
            if (e) {
              const t = l.x + d
              h.right >= u.width
                ? (n.position.x = u.width - t)
                : h.left <= 0 && (n.position.x = t)
            }
          }
          if (
            e === c.bounce ||
            ...
            const t = n.velocity.vertical
            let e = !1
            if (
              (i === s.bottom && h.bottom >= o.canvas.size.height && t > 0) ||
              (i === s.top && h.top <= 0 && t < 0)
            ) {
              const t = x.getValue(n.particlesOptions.bounce.vertical)
              ;(n.velocity.vertical *= -t), (e = !0)
            }
            if (e) {
              const t = l.y + d
              h.bottom >= u.height
                ? (n.position.y = u.height - t)
                : h.top <= 0 && (n.position.y = t)
            }
          }
        }
      }
      ...
      class V {
        ...
        load(t) {
          void 0 !== t &&
            ...
            (this.color = F.create(this.color, t.color)),
      ...
      class q {
        ...
        load(t) {
          void 0 !== t &&
            (void 0 !== t.color && (this.color = F.create(this.color, t.color)),
            void 0 !== t.enable && (this.enable = t.enable),
      ...
      class W {
        constructor() {
          ;(this.enable = !1),
            (this.length = 10),
            (this.fillColor = new F()),
            (this.fillColor.value = '#000000')
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.enable && (this.enable = t.enable),
            (this.fillColor = F.create(this.fillColor, t.fillColor)),
      ...
      class G {
        constructor() {
          ;(this.delay = new j()), (this.enable = !1)
        }
        load(t) {
          void 0 !== t &&
      ...
      class Z {
        constructor() {
          ;(this.density = new Q()), (this.limit = 0), (this.value = 100)
        }
        get max() {
          return this.limit
        }
      ...
      class it {
        constructor() {
          ;(this.options = {}), (this.type = a.circle)
        }
        get image() {
          var t
          return null !== (t = this.options[a.image]) && void 0 !== t
            ? t
            : this.options[a.images]
        }
        set image(t) {
          ;(this.options[a.image] = t), (this.options[a.images] = t)
        }
        get custom() {
          return this.options
        }
        ...
        get character() {
          var t
          return null !== (t = this.options[a.character]) && void 0 !== t
            ? t
            : this.options[a.char]
        }
        set character(t) {
          ;(this.options[a.character] = t), (this.options[a.char] = t)
        }
        get polygon() {
          var t
          return null !== (t = this.options[a.polygon]) && void 0 !== t
            ? t
            : this.options[a.star]
        }
        set polygon(t) {
          ;(this.options[a.polygon] = t), (this.options[a.star] = t)
        }
        load(t) {
          var i, e, o
          if (void 0 === t) return
          ...
          if (void 0 !== s)
            for (const t in s) {
              const i = s[t]
              void 0 !== i &&
                (this.options[t] = k.deepExtend(
                  null !== (e = this.options[t]) && void 0 !== e ? e : {},
                  i
                ))
            }
          this.loadShape(t.character, a.character, a.char, !0),
            this.loadShape(t.polygon, a.polygon, a.star, !1),
            this.loadShape(
          ...
          void 0 !== t &&
            (t instanceof Array
              ? (this.options[i] instanceof Array ||
                ...
                (this.options[i] = k.deepExtend(
                  null !== (s = this.options[i]) && void 0 !== s ? s : [],
                  t
                )),
                (this.options[e] && !o) ||
                  (this.options[e] = k.deepExtend(
      ...
      class ht {
        constructor() {
          ;(this.horizontal = new dt()), (this.vertical = new dt())
        }
        load(t) {
          t &&
      ...
      class ut {
        constructor() {
          ;(this.bounce = new ht()), (this.enable = !1), (this.mode = u.bounce)
        }
        load(t) {
          void 0 !== t &&
      ...
      class pt {
        constructor() {
          ;(this.lines = new vt()), (this.particles = new vt())
        }
        load(t) {
          void 0 !== t &&
      ...
      class ft {
        constructor() {
          ;(this.count = 0), (this.delay = new yt()), (this.duration = new mt())
        }
        load(t) {
          void 0 !== t &&
        ...
        load(t) {
          ...
          void 0 !== d &&
            (d instanceof Array
              ...
              : (this.stroke instanceof Array && (this.stroke = new ct()),
                this.stroke.load(d)))
        }
      }
      class bt {
      ...
      class wt {
        ...
        moveParticle(t) {
          ...
          this.applyNoise(t)
          const d = s.move.gravity
          d.enable &&
            (o.velocity.vertical += (d.acceleration * t.factor) / (60 * c))
          const h = {
            horizontal: o.velocity.horizontal * c,
            vertical: o.velocity.vertical * c,
          }
          d.enable &&
            h.vertical >= d.maxSpeed &&
            d.maxSpeed > 0 &&
            ((h.vertical = d.maxSpeed), (o.velocity.vertical = h.vertical / c)),
            (o.position.x += h.horizontal),
            (o.position.y += h.vertical),
            s.move.vibrate &&
              ((o.position.x += Math.sin(
                o.position.x * Math.cos(o.position.y)
              )),
              (o.position.y += Math.cos(o.position.y * Math.sin(o.position.x))))
          const u = o.initialPosition,
            v = x.getDistance(u, o.position)
          o.maxDistance &&
            (v >= o.maxDistance && !o.misplaced
              ? ((o.misplaced = v > o.maxDistance),
              ...
              ? (o.misplaced = !1)
              : o.misplaced &&
                (((o.position.x < u.x && o.velocity.horizontal < 0) ||
                  (o.position.x > u.x && o.velocity.horizontal > 0)) &&
                  (o.velocity.horizontal *= -Math.random()),
                ((o.position.y < u.y && o.velocity.vertical < 0) ||
                  (o.position.y > u.y && o.velocity.vertical > 0)) &&
        ...
        applyNoise(t) {
          ...
          ;(i.velocity.horizontal += Math.cos(o.angle) * o.length),
            (i.velocity.horizontal = x.clamp(i.velocity.horizontal, -1, 1)),
            (i.velocity.vertical += Math.sin(o.angle) * o.length),
            (i.velocity.vertical = x.clamp(i.velocity.vertical, -1, 1)),
            (i.lastNoiseTime -= i.noiseDelay)
        }
        moveParallax() {
          const t = this.container,
            i = t.options
          if (k.isSsr() || !i.interactivity.events.onHover.parallax.enable)
            return
          const e = this.particle,
        ...
        getProximitySpeedFactor() {
          const t = this.container,
            i = t.options
          if (!k.isInArray(v.slow, i.interactivity.events.onHover.mode))
            return 1
      ...
      class xt {
        constructor(t, i, e, o) {
          ...
          const m = i.retina.pixelRatio,
            ...
            g = new gt()
          g.load(f.particles)
          const b = g.shape.type,
            w = g.reduceDuplicates
          if (
            ((this.shape =
              b instanceof Array ? k.itemFromArray(b, this.id, w) : b),
            null == o ? void 0 : o.shape)
          ) {
            if (o.shape.type) {
              const t = o.shape.type
              this.shape =
                t instanceof Array ? k.itemFromArray(t, this.id, w) : t
            }
            const t = new it()
            if ((t.load(o.shape), this.shape)) {
              const i = t.options[this.shape]
              i &&
                (this.shapeData = k.deepExtend(
                  {},
                  i instanceof Array ? k.itemFromArray(i, this.id, w) : i
                ))
            }
          } else {
          ...
          void 0 !== o && g.load(o),
            ...
            (this.noiseDelay =
              1e3 * x.getValue(this.particlesOptions.move.noise.delay)),
            i.retina.initParticle(this)
          const z = this.particlesOptions.color,
            P = this.particlesOptions.size,
            S = x.getValue(P) * i.retina.pixelRatio,
            R = 'boolean' == typeof P.random ? P.random : P.random.enable
          ;(this.size = { value: S }),
          ...
          const C = this.particlesOptions.rotate
          this.rotate = {
            value:
              ((C.random.enable ? 360 * Math.random() : C.value) * Math.PI) /
              180,
          }
          let A = C.direction
          if (A === h.random) {
          ...
          switch (A) {
            ...
            case 'counterClockwise':
              this.rotate.status = r.decreasing
              break
            case h.clockwise:
              this.rotate.status = r.increasing
          }
          const T = this.particlesOptions.rotate.animation
          T.enable &&
            ((this.rotate.velocity = (T.speed / 360) * i.retina.reduceFactor),
            T.sync || (this.rotate.velocity *= Math.random()))
          const E = this.particlesOptions.size.animation
          if (E.enable) {
            if (((this.size.status = r.increasing), !R))
              switch (E.startValue) {
                case d.min:
                  this.size.value = E.minimumValue * m
                  break
                case d.random:
                  this.size.value = x.randomInRange(
                    E.minimumValue * m,
                    this.size.value
                  )
                  break
                case d.max:
                default:
                  this.size.status = r.decreasing
              }
            ;(this.size.velocity =
              ((null !== (v = this.sizeAnimationSpeed) && void 0 !== v
                ? v
          ...
          this.color = { value: D.colorToHsl(z, this.id, w) }
          const I = this.particlesOptions.color.animation
          I.enable &&
            ((this.color.velocity = (I.speed / 100) * i.retina.reduceFactor),
            I.sync || (this.color.velocity *= Math.random())),
            (this.position = this.calcPosition(this.container, e)),
            (this.initialPosition = { x: this.position.x, y: this.position.y }),
            (this.offset = { x: 0, y: 0 })
          const O = this.particlesOptions.opacity,
            L = O.random,
            F = O.value
          this.opacity = {
            value: L.enable ? x.randomInRange(L.minimumValue, F) : F,
          }
          const V = O.animation
          V.enable &&
            ((this.opacity.status = r.increasing),
            (this.opacity.velocity = (V.speed / 100) * i.retina.reduceFactor),
            V.sync || (this.opacity.velocity *= Math.random())),
            (this.sides = 24)
          let q = i.drawers.get(this.shape)
          q ||
            ((q = M.getShapeDrawer(this.shape)),
            q && i.drawers.set(this.shape, q))
          const _ = null == q ? void 0 : q.getSidesCount
          _ && (this.sides = _(this))
          const B = this.loadImageShape(i, q)
          if (
            (B &&
              ((this.image = B.image),
              (this.fill = B.fill),
            ...
            (this.stroke =
              this.particlesOptions.stroke instanceof Array
                ? k.itemFromArray(this.particlesOptions.stroke, this.id, w)
                : this.particlesOptions.stroke),
            (this.strokeWidth = this.stroke.width * i.retina.pixelRatio),
            (this.strokeColor = {
              value:
                null !== (p = D.colorToHsl(this.stroke.color)) && void 0 !== p
                  ? p
                  : this.color.value,
            }),
            ...
            const t =
              null === (y = this.stroke.color) || void 0 === y
                ? void 0
                : y.animation
            t &&
              this.strokeColor &&
          ...
          ;(this.lifeDelay = i.retina.reduceFactor
            ? ((x.getValue(W.delay) * (W.delay.sync ? 1 : Math.random())) /
                i.retina.reduceFactor) *
              1e3
            : 0),
            (this.lifeDelayTime = 0),
            (this.lifeDuration = i.retina.reduceFactor
              ? ((x.getValue(W.duration) *
                  (W.duration.sync ? 1 : Math.random())) /
                  i.retina.reduceFactor) *
                1e3
              : 0),
            (this.lifeTime = 0),
            ...
            (this.shadowColor = D.colorToRgb(
              this.particlesOptions.shadow.color
            )),
            (this.updater = new H(i, this)),
            (this.infecter = new bt(i)),
            (this.mover = new wt(i, this))
        }
        move(t) {
          this.mover.move(t)
        }
        ...
        calcPosition(t, i) {
          ...
          for (const [, e] of t.plugins) {
            const t =
              void 0 !== e.particlePosition
                ...
                : void 0
            if (void 0 !== t) return k.deepExtend({}, t)
          }
          const s = {
              x:
          ...
          return (
            (k.isInArray(n, c.bounce) || k.isInArray(n, c.bounceHorizontal)) &&
              (s.x > t.canvas.size.width - 2 * this.size.value
                ? (s.x -= this.size.value)
                : s.x < 2 * this.size.value && (s.x += this.size.value)),
            (k.isInArray(n, c.bounce) || k.isInArray(n, c.bounceVertical)) &&
        ...
        calculateVelocity() {
          const t = x.getParticleBaseVelocity(this),
          ...
          return (
            e.straight
              ? ((i.horizontal = t.x),
                (i.vertical = t.y),
                e.random &&
                  ((i.horizontal += x.randomInRange(n.left, n.right) / 2),
                  (i.vertical += x.randomInRange(n.left, n.right) / 2)))
              : ((i.horizontal = t.x + x.randomInRange(n.left, n.right) / 2),
                (i.vertical = t.y + x.randomInRange(n.left, n.right) / 2)),
            i
          )
        }
        loadImageShape(t, i) {
          var e, o, s, n, r
          if (this.shape !== a.image && this.shape !== a.images) return
          const l = i.getImages(t).images,
            c = this.shapeData,
            d =
              null !== (e = l.find((t) => t.source === c.src)) && void 0 !== e
                ? e
                : l[0],
            h = this.getFillColor()
          let u
          ...
          if (void 0 !== d.svgData && c.replaceColor && h) {
            const t = D.replaceColorSvg(d, h, this.opacity.value),
            ...
            ;(u = {
              ...
              replaceColor:
                null !== (o = c.replaceColor) && void 0 !== o
                  ? o
                  : c.replace_color,
              source: c.src,
            }),
            ...
            u = {
              ...
              ratio: c.width / c.height,
              replaceColor:
                null !== (s = c.replaceColor) && void 0 !== s
                  ? s
                  : c.replace_color,
              source: c.src,
            }
          ...
          return {
            image: u,
            fill: null !== (n = c.fill) && void 0 !== n ? n : this.fill,
            close: null !== (r = c.close) && void 0 !== r ? r : this.close,
          }
        }
      }
      class kt {
      ...
      class Mt extends Pt {
        ...
        intersects(t) {
          ...
          if (void 0 !== e.radius) {
            const t = new Pt(o.x, o.y, 2 * e.radius)
      ...
      class St {
        ...
        subdivide() {
          const t = this.rectangle.position.x,
            ...
            s = this.capacity
          ;(this.northEast = new St(new zt(t, i, e / 2, o / 2), s)),
            (this.northWest = new St(new zt(t + e / 2, i, e / 2, o / 2), s)),
            (this.southEast = new St(new zt(t, i + o / 2, e / 2, o / 2), s)),
            (this.southWest = new St(
              new zt(t + e / 2, i + o / 2, e / 2, o / 2),
              s
            )),
            (this.divided = !0)
        }
        ...
        queryCircle(t, i) {
          return this.query(new Pt(t.x, t.y, i))
        }
        queryCircleWarp(t, i, e) {
          const o = e,
            s = e
          return this.query(
            new Mt(t.x, t.y, i, void 0 !== o.canvas ? o.canvas.size : s)
          )
        }
        queryRectangle(t, i) {
      ...
      class Ct {
        ...
        interact() {
          ...
          if (
            ...
            i.interactivity.status === I.mouseMoveEvent
          ) {
              ...
              if (r <= s) {
                ...
                if (c > 0) {
                  ...
                  if (!i.particles.grabLineColor) {
                    ...
                    i.particles.grabLineColor = D.getLinkRandomColor(
                      e,
                      t.blink,
                      t.consent
                    )
                  }
                  const s = D.getLinkColor(a, void 0, i.particles.grabLineColor)
                  if (void 0 === s) return
      ...
      class At {
        ...
        isEnabled() {
          const t = this.container,
            ...
            s = o.onDiv,
            n = k.isDivModeEnabled(p.repulse, s)
          if (
            !(
              n ||
          ...
          const a = o.onHover.mode,
            r = o.onClick.mode
          return k.isInArray(v.repulse, a) || k.isInArray(y.repulse, r) || n
        }
        reset() {}
        interact() {
          const t = this.container,
            i = t.options,
            e = t.interactivity.status === I.mouseMoveEvent,
            o = i.interactivity.events,
            s = o.onHover.enable,
            n = o.onHover.mode,
            a = o.onClick.enable,
            r = o.onClick.mode,
            l = o.onDiv
          e && s && k.isInArray(v.repulse, n)
            ? this.hoverRepulse()
            : a && k.isInArray(y.repulse, r)
            ? this.clickRepulse()
            : k.divModeExecute(p.repulse, l, (t, i) =>
        ...
        hoverRepulse() {
          ...
          this.processRepulse(i, e, new Pt(i.x, i.y, e))
        }
        processRepulse(t, i, e, o) {
          ...
          for (const e of a) {
            const { dx: a, dy: r, distance: l } = x.getDistances(e.position, t),
              c = { x: a / l, y: r / l },
              d =
                100 *
              ...
              h = x.clamp((1 - Math.pow(l / i, 2)) * d, 0, 50)
            ;(e.position.x = e.position.x + c.x * h),
              (e.position.y = e.position.y + c.y * h)
          }
        }
        clickRepulse() {
          const t = this.container
          if (
            ...
            for (const i of n) {
              ...
              if (r <= e) {
                ...
                ;(i.velocity.horizontal = c * Math.cos(e)),
                  (i.velocity.vertical = c * Math.sin(e))
              }
            }
      ...
      class Tt {
        ...
        static calculateBubbleValue(t, i, e, o) {
          if (i > e) {
            const s = t + (i - e) * o
            return x.clamp(s, t, i)
          }
          if (i < e) {
            const s = t - (e - i) * o
            return x.clamp(s, i, t)
          }
        }
        isEnabled() {
          const t = this.container,
            ...
            o = i.interactivity.events,
            s = o.onDiv,
            n = k.isDivModeEnabled(p.bubble, s)
          if (
            !(
              n ||
              (o.onHover.enable && e.position) ||
          ...
          const a = o.onHover.mode,
            r = o.onClick.mode
          return k.isInArray(v.bubble, a) || k.isInArray(y.bubble, r) || n
        }
        reset(t, i) {
          ;(t.bubble.inRange && !i) ||
            (delete t.bubble.div,
        ...
        interact() {
          const t = this.container.options.interactivity.events,
            ...
            a = e.mode,
            r = t.onDiv
          o && k.isInArray(v.bubble, s)
            ? this.hoverBubble()
            : n && k.isInArray(y.bubble, a)
            ? this.clickBubble()
            : k.divModeExecute(p.bubble, r, (t, i) =>
        ...
        process(t, i, e, o) {
          ...
          if (n !== l)
            if (s.bubble.durationEnd)
              c &&
                (h === f.size && delete t.bubble.radius,
                h === f.opacity && delete t.bubble.opacity)
            else if (i <= r) {
              if ((null != c ? c : d) !== n) {
                const i = d - (e * (d - n)) / a
                h === f.size && (t.bubble.radius = i),
                  h === f.opacity && (t.bubble.opacity = i)
              }
            } else
              h === f.size && delete t.bubble.radius,
                h === f.opacity && delete t.bubble.opacity
          ...
          for (const s of n) {
            ...
            const n = s.getPosition(),
              ...
              r =
                ...
                1e3
            r > e.interactivity.modes.bubble.duration &&
              (i.bubble.durationEnd = !0),
              r > 2 * e.interactivity.modes.bubble.duration &&
        ...
        hoverBubble() {
          ...
          for (const s of o) {
            ...
            n <= e
              ? a >= 0 &&
                t.interactivity.status === I.mouseMoveEvent &&
                (this.hoverBubbleSize(s, a),
                this.hoverBubbleOpacity(s, a),
                this.hoverBubbleColor(s))
              : this.reset(s),
              t.interactivity.status === I.mouseLeaveEvent && this.reset(s)
          }
        }
        hoverBubbleSize(t, i, e) {
          ...
          const a =
              null !== (o = t.sizeValue) && void 0 !== o
                ...
                : s.retina.sizeValue,
            r = t.size.value,
            l = Tt.calculateBubbleValue(r, n, a, i)
        ...
        hoverBubbleColor(t, i) {
          ...
          if (void 0 === t.bubble.color) {
            ...
            if (void 0 === s) return
            const n = s instanceof Array ? k.itemFromArray(s) : s
      ...
      class Et {
        ...
        isEnabled() {
          ...
          if (!e.onHover.enable || !i.position) return !1
          const o = e.onHover.mode
          return k.isInArray(v.connect, o)
        }
        reset() {}
        interact() {
          const t = this.container
      ...
      class It {
        ...
        interact(t) {
          ...
          const e = this.container,
            ...
            r = o.warp,
            l = t.getPosition(),
            c = r ? new Mt(l.x, l.y, n, a) : new Pt(l.x, l.y, n),
            d = e.particles.quadTree.query(c)
          for (const i of d) {
            const c = i.particlesOptions.links
            if (t === i || !c.enable || o.id !== c.id) continue
            const d = i.getPosition()
            let h = x.getDistance(l, d)
            if (r && h > n) {
              const t = { x: d.x - a.width, y: d.y }
              if (((h = x.getDistance(l, t)), h > n)) {
            ...
            if (u > 0) {
              ...
              let s =
                void 0 !== o.id
                  ? e.particles.linksColors.get(o.id)
                  : e.particles.linksColor
              if (!s) {
                const t = o.color
                ;(s = D.getLinkRandomColor(t, o.blink, o.consent)),
                  void 0 !== o.id
                    ? e.particles.linksColors.set(o.id, s)
                    : (e.particles.linksColor = s)
              }
              ;-1 === i.links.map((t) => t.destination).indexOf(t) &&
                -1 === t.links.map((t) => t.destination).indexOf(i) &&
                t.links.push({ destination: i, opacity: u })
            }
          }
        }
      }
          ...
          const e = this.container,
            ...
            s =
              null !== (i = t.linksDistance) && void 0 !== i
                ...
                : e.retina.linksDistance,
            n = t.getPosition(),
            a = e.particles.quadTree.queryCircle(n, s)
          for (const i of a) {
            if (
              t === i ||
              ...
              continue
            const e = i.getPosition(),
              { dx: s, dy: a } = x.getDistances(n, e),
              r = o.particles.move.attract.rotate,
              l = s / (1e3 * r.x),
              c = a / (1e3 * r.y)
      ...
      class Ot {
        ...
        static bounce(t, i) {
          k.circleBounce(
            k.circleBounceDataFromParticle(t),
            k.circleBounceDataFromParticle(i)
          )
        }
        static destroy(t, i) {
          void 0 === t.getRadius() && void 0 !== i.getRadius()
            ...
            : void 0 !== t.getRadius() &&
              void 0 !== i.getRadius() &&
              (t.getRadius() >= i.getRadius() ? i.destroy() : t.destroy())
        }
        isEnabled(t) {
        ...
        interact(t) {
          ...
          for (const i of o) {
            ...
            x.getDistance(e, o) <= t.getRadius() + i.getRadius() &&
        ...
        absorb(t, i) {
          ...
          if (void 0 === t.getRadius() && void 0 !== i.getRadius()) t.destroy()
            ...
            if (t.getRadius() >= i.getRadius()) {
              const s =
                x.clamp(t.getRadius() / i.getRadius(), 0, i.getRadius()) * o
              ;(t.size.value += s),
                (i.size.value -= s),
              ...
              const s =
                x.clamp(i.getRadius() / t.getRadius(), 0, t.getRadius()) * o
              ;(t.size.value -= s),
                (i.size.value += s),
      ...
      class Ht {
        ...
        interact(t) {
          ...
          this.delay < o && (this.delay += t.value),
            this.delay >= o &&
              (i.particles.push(e.quantity, i.interactivity.mouse, e.particles),
              (this.delay -= o))
        }
        isEnabled() {
          const t = this.container,
          ...
          return (
            (e.clicking &&
              e.inside &&
              !!e.position &&
              k.isInArray(y.trail, o.onClick.mode)) ||
            (e.inside && !!e.position && k.isInArray(v.trail, o.onHover.mode))
          )
        }
        reset() {}
      }
      class Ft {
        ...
        isEnabled() {
          ...
          const s = o.onHover.mode,
            n = o.onClick.mode
          return k.isInArray(v.attract, s) || k.isInArray(y.attract, n)
        }
        reset() {}
        interact() {
          const t = this.container,
            ...
            a = o.onClick.enable,
            r = o.onClick.mode
          e && s && k.isInArray(v.attract, n)
            ? this.hoverAttract()
            : a && k.isInArray(y.attract, r) && this.clickAttract()
        }
        hoverAttract() {
          const t = this.container,
            i = t.interactivity.mouse.position
          ...
          this.processAttract(i, e, new Pt(i.x, i.y, e))
        }
        processAttract(t, i, e) {
          const o = this.container,
            s = o.particles.quadTree.query(e)
          for (const e of s) {
            const { dx: s, dy: n, distance: a } = x.getDistances(e.position, t),
              r = { x: s / a, y: n / a },
              l = o.options.interactivity.modes.attract.speed,
              c = x.clamp((1 - Math.pow(a / i, 2)) * l, 0, 50)
            ;(e.position.x = e.position.x - r.x * c),
              (e.position.y = e.position.y - r.y * c)
          }
        }
        clickAttract() {
          const t = this.container
      ...
      class _t {
        ...
        isEnabled() {
          ...
          return (
            (e.position &&
              o.onHover.enable &&
              k.isInArray(v.bounce, o.onHover.mode)) ||
            k.isDivModeEnabled(p.bounce, s)
          )
        }
        interact() {
          const t = this.container,
            ...
            s = i.onHover.mode,
            n = i.onDiv
          e && o && k.isInArray(v.bounce, s)
            ? this.processMouseBounce()
            : k.divModeExecute(p.bounce, n, (t, i) =>
        ...
        processMouseBounce() {
          ...
          e && this.processBounce(e, o, new Pt(e.x, e.y, o + i))
        }
        ...
        processBounce(t, i, e) {
          ...
          for (const s of o)
            e instanceof Pt
              ? k.circleBounce(k.circleBounceDataFromParticle(s), {
                  position: t,
                  radius: i,
                  velocity: { horizontal: 0, vertical: 0 },
                  factor: { horizontal: 0, vertical: 0 },
                })
              : e instanceof zt && k.rectBounce(s, k.calculateBounds(t, i))
        }
      }
      class Bt {
        constructor(t) {
      ...
      class Wt {
        constructor(t) {
          ;(this.container = t),
            ...
            (this.interactionManager = new Bt(t))
          const i = this.container.canvas.size
          ;(this.linksColors = new Map()),
            (this.quadTree = new St(
              new zt(
                -i.width / 4,
                -i.height / 4,
                (3 * i.width) / 2,
        ...
        init() {
          ...
          if (i.infection.enable)
            for (let t = 0; t < i.infection.infections; t++) {
              ...
              k.itemFromArray(t).infecter.startInfection(0)
            }
        ...
        update(t) {
          ...
          for (const e of this.array)
            e.move(t),
              e.destroyed
                ? i.push(e)
                : this.quadTree.insert(new Rt(e.getPosition(), e))
        ...
        addParticle(t, i) {
          try {
            const e = new xt(this.nextId, this.container, t, i)
        ...
        getTriangleFrequency(t, i, e) {
          ...
          return (
            void 0 === r && ((r = Math.random()), this.trianglesFreq.set(a, r)),
            r
          )
        }
      }
      class Nt {
        ...
        init() {
          ...
          if (
            (i.detectRetina
              ? (this.pixelRatio = k.isSsr() ? 1 : window.devicePixelRatio)
              : (this.pixelRatio = 1),
            k.isSsr() || 'undefined' == typeof matchMedia || !matchMedia)
          )
            this.reduceFactor = 1
          else {
            ...
            this.handleMotionChange(i),
              i.addEventListener('change', () =>
                o(this, void 0, void 0, function* () {
                  this.handleMotionChange(i), yield t.refresh()
                })
              )
          }
          ...
          ;(this.connectModeDistance = n.connect.distance * e),
            (this.connectModeRadius = n.connect.radius * e),
            (this.grabModeDistance = n.grab.distance * e),
            (this.repulseModeDistance = n.repulse.distance * e),
            (this.bounceModeDistance = n.bounce.distance * e),
            (this.attractModeDistance = n.attract.distance * e),
            (this.slowModeRadius = n.slow.radius * e),
            (this.bubbleModeDistance = n.bubble.distance * e),
            n.bubble.size && (this.bubbleModeSize = n.bubble.size * e)
        }
        initParticle(t) {
      ...
      class Xt {
        constructor() {
          ;(this.enable = !1), (this.mode = []), (this.parallax = new $t())
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.enable && (this.enable = t.enable),
        ...
        load(t) {
          ...
          void 0 !== s &&
            (s instanceof Array
              ...
              : ((this.onDiv = new Gt()), this.onDiv.load(s))),
            this.onHover.load(
          ...
          void 0 !== t &&
            ...
            void 0 !== t.color &&
              (t.color instanceof Array
                ? (this.color = t.color.map((t) => F.create(void 0, t)))
                : (this.color instanceof Array && (this.color = new F()),
                  (this.color = F.create(this.color, t.color)))),
            void 0 !== t.size && (this.size = t.size))
        }
      }
      ...
      class ti {
        constructor() {
          ;(this.distance = 80), (this.links = new Kt()), (this.radius = 60)
        }
        get line_linked() {
          return this.links
        }
      ...
      class ei {
        constructor() {
          ;(this.distance = 100), (this.links = new ii())
        }
        get line_linked() {
          return this.links
        }
      ...
      class ci {
        ...
        load(t) {
          void 0 !== t &&
            ...
            void 0 !== t.particles &&
              (this.particles = k.deepExtend({}, t.particles)))
        }
      }
      class di {
        constructor() {
      ...
      class hi {
        ...
        load(t) {
          void 0 !== t &&
            ((this.start = F.create(this.start, t.start)),
            (this.stop = F.create(this.stop, t.stop)))
        }
      }
      class ui {
        constructor() {
          ;(this.gradient = new hi()), (this.radius = 1e3)
        }
        load(t) {
          void 0 !== t &&
      ...
      class pi {
        constructor() {
          ;(this.area = new ui()), (this.shadow = new vi())
        }
        load(t) {
          ...
          void 0 !== s && (this.detectsOn = s),
            ...
            !0 ===
              ...
              (this.events.onHover.mode instanceof Array
                ? this.events.onHover.mode.indexOf(v.slow) < 0 &&
                  this.events.onHover.mode.push(v.slow)
                : this.events.onHover.mode !== v.slow &&
      ...
      class gi {
        constructor() {
          ;(this.color = new F()), (this.opacity = 1)
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.color && (this.color = F.create(this.color, t.color)),
      ...
      class Pi {
        ...
        load(t) {
          void 0 !== t &&
            ...
            void 0 !== t.options &&
              (this.options = k.deepExtend({}, t.options)))
        }
      }
      class Mi {
        constructor() {
      ...
      class Ri {
        constructor() {
          ;(this.disable = !1), (this.reduce = new Si())
        }
        load(t) {
          t &&
      ...
      class Ci {
        ...
        load(t) {
          ...
          t &&
            (void 0 !== t.position &&
              ((this.position.x =
                null !== (i = t.position.x) && void 0 !== i
                  ? i
                  : this.position.x),
              (this.position.y =
                null !== (e = t.position.y) && void 0 !== e
                  ? e
                  : this.position.y)),
            void 0 !== t.options &&
              (this.options = k.deepExtend({}, t.options)))
      ...
      class Ai {
        constructor() {
          ;(this.autoPlay = !0),
            (this.background = new wi()),
            (this.backgroundMask = new bi()),
            (this.backgroundMode = new Mi()),
            (this.detectRetina = !0),
            (this.fpsLimit = 30),
            (this.infection = new ki()),
            (this.interactivity = new fi()),
        ...
        setTheme(t) {
          if (t) {
            ...
            let i = this.themes.find(
              (i) =>
                i.default.value &&
                ((i.default.mode === b.dark && t) ||
                  (i.default.mode === b.light && !t))
            )
            i ||
              (i = this.themes.find(
                (t) => t.default.value && t.default.mode === b.any
              )),
              i && this.load(i.options)
          }
        }
      ...
      class Ti {
        ...
        manageListeners(t) {
          ...
          let s = I.mouseLeaveEvent
          o === g.window
            ? ((i.interactivity.element = window), (s = I.mouseOutEvent))
            : o === g.parent && i.canvas.element
            ? (i.interactivity.element = i.canvas.element.parentNode)
            : (i.interactivity.element = i.canvas.element)
          const n = i.interactivity.element
          n &&
            (e.interactivity.events.onHover.enable ||
              e.interactivity.events.onClick.enable) &&
            (Ti.manageListener(n, I.mouseMoveEvent, this.mouseMoveHandler, t),
            Ti.manageListener(n, I.touchStartEvent, this.touchStartHandler, t),
            Ti.manageListener(n, I.touchMoveEvent, this.touchMoveHandler, t),
            e.interactivity.events.onClick.enable ||
              Ti.manageListener(n, I.touchEndEvent, this.touchEndHandler, t),
            Ti.manageListener(n, s, this.mouseLeaveHandler, t),
            Ti.manageListener(
              n,
              I.touchCancelEvent,
            ...
            e.interactivity.events.onClick.enable &&
              ...
              Ti.manageListener(n, I.mouseUpEvent, this.mouseUpHandler, t),
              Ti.manageListener(n, I.mouseDownEvent, this.mouseDownHandler, t)),
            e.interactivity.events.resize &&
              Ti.manageListener(window, I.resizeEvent, this.resizeHandler, t),
            document &&
              Ti.manageListener(
                document,
                I.visibilityChangeEvent,
                this.visibilityChangeHandler,
                t,
                !1
              )
        ...
        mouseTouchMove(t) {
          ...
          if (
            ...
            return
          let a
          s.interactivity.mouse.inside = !0
          ...
          if (t.type.startsWith('mouse')) {
            ...
            if (s.interactivity.element === window) {
              if (r) {
                ...
                a = { x: i.clientX - t.left, y: i.clientY - t.top }
              }
              ...
              if (t && e) {
                ...
                a = {
                  x: i.offsetX + o.left - s.left,
                  y: i.offsetY + o.top - s.top,
                }
              } else
                a = { x: i.offsetX || i.clientX, y: i.offsetY || i.clientY }
            } else
              i.target === s.canvas.element &&
                (a = { x: i.offsetX || i.clientX, y: i.offsetY || i.clientY })
          } else {
          ...
          a && ((a.x *= l), (a.y *= l)),
            (s.interactivity.mouse.position = a),
            (s.interactivity.status = I.mouseMoveEvent)
        }
        mouseTouchFinish() {
          const t = this.container.interactivity
          if (void 0 === t) return
      ...
      class Ei {
        constructor(t, i, ...e) {
          ;(this.id = t),
            ...
            (this.pageHidden = !1),
            (this.retina = new Nt(this)),
            (this.canvas = new L(this)),
            (this.particles = new Wt(this)),
            (this.drawer = new Ut(this)),
            (this.noise = {
              generate: () => ({
          ...
          this.sourceOptions && this.options.load(this.sourceOptions),
            ...
            (this.eventListeners = new Ti(this))
        }
        play(t) {
        ...
        pause() {
          if (
            (void 0 !== this.drawAnimationFrame &&
              (k.cancelAnimation(this.drawAnimationFrame),
        ...
        draw() {
          this.drawAnimationFrame = k.animate((t) => this.drawer.nextFrame(t))
        }
        getAnimationStatus() {
          return !this.paused
        }
        ...
        densityAutoParticles() {
          if (!this.options.particles.number.density.enable) return
        ...
        init() {
          return o(this, void 0, void 0, function* () {
            ...
            for (const [, t] of this.plugins)
              t.init
                ? t.init(this.options)
                : void 0 !== t.initAsync && (yield t.initAsync(this.options))
            this.canvas.windowResize(), this.particles.init()
          })
        }
        initDensityFactor() {
          ...
          this.density = (i.width * i.height) / (t.factor * e * e * t.area)
        }
      }
      const Ii = []
      class Di {
        ...
        static load(t, i, e) {
          return o(this, void 0, void 0, function* () {
            ...
            if (o) return Di.set(t, o, i, e)
          })
        }
        static set(t, i, e, s) {
          return o(this, void 0, void 0, function* () {
            const o = e instanceof Array ? k.itemFromArray(e, s) : e,
              n = Di.dom(),
              a = n.findIndex((i) => i.id === t)
            if (a >= 0) {
              const t = Di.domItem(a)
            ...
            if ('canvas' === i.tagName.toLowerCase()) (r = i), (l = !1)
              ...
              t.length
                ? ((r = t[0]),
                  r.className || (r.className = I.canvasClass),
                  (l = !1))
                : ((l = !0),
                  (r = document.createElement('canvas')),
                  (r.className = I.canvasClass),
                  (r.style.width = '100%'),
                  (r.style.height = '100%'),
                  i.appendChild(r))
            }
        ...
        static loadJSON(t, i, e) {
          return o(this, void 0, void 0, function* () {
            const o = i instanceof Array ? k.itemFromArray(i, e) : i,
              s = yield fetch(o)
            if (s.ok) return Di.load(t, yield s.json())
            Di.fetchError(s.status)
          })
        }
      ...
      class Oi {
        constructor(t, i, e, o) {
          ...
          ;(this.absorbers = t),
            ...
            (this.size = x.getValue(e.size) * i.retina.pixelRatio),
            (this.mass = this.size * e.size.density * i.retina.reduceFactor)
          const a = e.size.limit
          this.limit =
            void 0 !== a ? a * i.retina.pixelRatio * i.retina.reduceFactor : a
          const r = 'string' == typeof e.color ? { value: e.color } : e.color
          ;(this.color =
            null !== (s = D.colorToRgb(r)) && void 0 !== s
              ? s
              : { b: 0, g: 0, r: 0 }),
            (this.position =
        ...
        attract(t) {
          ...
          if (i.draggable) {
            ...
            if (t.clicking && t.downPosition) {
              x.getDistance(this.position, t.downPosition) <= this.size &&
                (this.dragging = !0)
          ...
          const e = t.getPosition(),
            { dx: o, dy: s, distance: n } = x.getDistances(this.position, e),
            a = Math.atan2(o, s),
            r =
              (this.mass / Math.pow(n, 2)) * this.container.retina.reduceFactor
          if (n < this.size + t.getRadius()) {
            const e = 0.033 * t.getRadius() * this.container.retina.pixelRatio
            this.size > t.getRadius() && n < this.size - t.getRadius()
              ? i.destroy
                ? t.destroy()
                : ((t.needsNewPosition = !0),
                  this.updateParticlePosition(t, a, r))
          ...
          } else this.updateParticlePosition(t, a, r)
        }
        resize() {
          const t = this.initialPosition
          this.position =
            t && k.isPointInside(t, this.container.canvas.size)
              ? t
              : this.calcPosition()
        }
        draw(t) {
          t.translate(this.position.x, this.position.y),
            ...
            t.closePath(),
            (t.fillStyle = D.getStyleFromRgb(this.color, this.opacity)),
            t.fill()
        }
        calcPosition() {
          var t
        ...
        updateParticlePosition(t, i, e) {
          ...
          if (this.options.orbits) {
            void 0 === t.orbitRadius &&
              (t.orbitRadius = x.getDistance(t.getPosition(), this.position)),
              t.orbitRadius <= this.size &&
                !this.options.destroy &&
                (t.orbitRadius = Math.random() * Math.max(s.width, s.height)),
              void 0 === t.orbitAngle &&
      ...
      class Vi {
        ...
        init(t) {
          ...
          t.absorbers &&
            (t.absorbers instanceof Array
              ...
              : (this.absorbers instanceof Array && (this.absorbers = new Hi()),
        ...
        handleClickMode(t) {
          ...
          if (t === Fi.absorber) {
            let t
            o instanceof Array
              ? o.length > 0 && (t = k.itemFromArray(o))
              : (t = o)
            const s =
                null != t ? t : e instanceof Array ? k.itemFromArray(e) : e,
              n = i.interactivity.mouse.clickPosition,
              a = new Oi(this, this.container, s, n)
            this.addAbsorber(a)
          }
        }
        addAbsorber(t) {
        ...
        loadOptions(t, i) {
          ...
          if (n)
            if (n instanceof Array)
              ...
              void 0 === (null == t ? void 0 : t.load) &&
                (s.interactivity.modes.absorbers = t = new Hi()),
                t.load(n)
            }
        }
      })()
      ...
      class Wi {
        constructor() {
          ;(this.mode = _i.percent), (this.height = 0), (this.width = 0)
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.mode && (this.mode = t.mode),
      ...
      class Ni {
        constructor(t, i, e, o) {
          ...
          ;(this.emitters = t),
            (this.container = i),
            (this.initialPosition = o),
            (this.emitterOptions = k.deepExtend({}, e)),
            (this.position =
              null !== (s = this.initialPosition) && void 0 !== s
                ? s
                : this.calcPosition())
          let r = k.deepExtend({}, this.emitterOptions.particles)
          void 0 === r && (r = {}),
            ...
            (this.size =
              null !== (n = this.emitterOptions.size) && void 0 !== n
                ...
                : (() => {
                    const t = new Wi()
                    return t.load({ height: 0, mode: _i.percent, width: 0 }), t
                  })()),
            (this.lifeCount =
      ...
      class Gi {
        ...
        load(t) {
          void 0 !== t &&
            (void 0 !== t.size &&
              (void 0 === this.size && (this.size = new Wi()),
              this.size.load(t.size)),
            void 0 !== t.direction && (this.direction = t.direction),
            this.life.load(t.life),
            void 0 !== t.particles &&
        ...
        handleClickMode(t) {
          ...
          if (t === Bi.emitter) {
            ...
            const s =
                null != t ? t : e instanceof Array ? k.itemFromArray(e) : e,
              n = i.interactivity.mouse.clickPosition,
              a = new Ni(this, this.container, k.deepExtend({}, s), n)
            this.addEmitter(a)
          }
        }
        resize() {
        ...
        loadOptions(t, i) {
          ...
          if (n)
            if (n instanceof Array)
              ...
              void 0 === (null == t ? void 0 : t.load) &&
                (s.interactivity.modes.emitters = t = new Gi()),
                t.load(n)
            }
        }
      })()
      ...
      class Zi {
        constructor() {
          ;(this.color = new F()), (this.width = 0.5), (this.opacity = 1)
        }
        load(t) {
          var i
          void 0 !== t &&
            ...
            'string' == typeof this.color.value &&
              (this.opacity =
                null !== (i = D.stringToAlpha(this.color.value)) && void 0 !== i
                  ? i
                  : this.opacity),
            void 0 !== t.opacity && (this.opacity = t.opacity),
            void 0 !== t.width && (this.width = t.width))
      ...
      class Ki {
        ...
        set lineColor(t) {
          this.stroke.color = F.create(this.stroke.color, t)
        }
        load(t) {
          var i
          if (void 0 !== t) {
      ...
      class te {
        constructor() {
          ;(this.radius = 10), (this.type = Qi.path)
        }
        load(t) {
          void 0 !== t &&
            (void 0 !== t.radius && (this.radius = t.radius),
      ...
      class se {
        ...
        static drawPolygonMaskPath(t, i, e, o) {
          t.translate(o.x, o.y)
          const s = D.colorToRgb(e.color)
          s &&
            ((t.strokeStyle = D.getStyleFromRgb(s, e.opacity)),
            (t.lineWidth = e.width),
            t.stroke(i))
        }
        ...
        particlesInitialization() {
          ...
          return (
            !(
              !t.enable ||
              t.type !== Yi.inline ||
              (t.inline.arrangement !== Ji.onePerPoint &&
                t.inline.arrangement !== Ji.perPoint)
            ) && (this.drawPoints(), !0)
          )
        }
        particlePosition(t) {
          ...
          if (
            ...
            return k.deepExtend({}, t || this.randomPoint())
        }
        particleBounce(t) {
          const i = this.options
          if (i.enable && i.type !== Yi.none && i.type !== Yi.inline) {
            if (!this.checkInsidePolygon(t.getPosition()))
              return se.polygonBounce(t), !0
          } else if (i.enable && i.type === Yi.inline && t.initialPosition) {
            if (
              x.getDistance(t.initialPosition, t.getPosition()) >
              this.polygonMaskMoveRadius
            )
              return se.polygonBounce(t), !0
          }
        ...
        draw(t) {
          ...
          for (const i of this.paths) {
            ...
            t &&
              (n && e && this.offset
                ? se.drawPolygonMaskPath(t, e, o.stroke, this.offset)
                : s && se.drawPolygonMask(t, s, o.stroke))
          }
        }
        checkInsidePolygon(t) {
          ...
          const o = this.container,
            s = this.options
          if (!s.enable || s.type === Yi.none || s.type === Yi.inline) return !0
          if (!this.raw) throw new Error(I.noPolygonFound)
          ...
          return s.type === Yi.inside ? l : s.type === Yi.outside && !l
        }
        parseSvgPath(t, i) {
          var e, o, s
          const n = null != i && i
          ...
          return (
            ...
            se.parsePaths(this.paths, u, this.offset)
          )
        }
        downloadSvgPath(t, i) {
          return o(this, void 0, void 0, function* () {
        ...
        getRandomPoint() {
          if (!this.raw || !this.raw.length)
            throw new Error(I.noPolygonDataLoaded)
        ...
        getRandomPointByLength() {
          ...
          if (
            ...
            throw new Error(I.noPolygonDataLoaded)
          const s = k.itemFromArray(this.paths),
            n = Math.floor(Math.random() * s.length) + 1,
            a = s.element.getPointAtLength(n)
          return {
            x:
              a.x * o.scale +
              ((null === (i = this.offset) || void 0 === i ? void 0 : i.x) ||
                0),
            y:
              a.y * o.scale +
              ((null === (e = this.offset) || void 0 === e ? void 0 : e.y) ||
                0),
          }
        }
      ...
      const ae = new (class extends class {
        constructor() {
          ...
          const t = new w(),
            i = new z(),
            e = new P()
          M.addShapeDrawer(a.line, new S()),
            M.addShapeDrawer(a.circle, new R()),
            M.addShapeDrawer(a.edge, t),
            M.addShapeDrawer(a.square, t),
            M.addShapeDrawer(a.triangle, new A()),
            M.addShapeDrawer(a.star, new T()),
            M.addShapeDrawer(a.polygon, new E()),
            M.addShapeDrawer(a.char, i),
            M.addShapeDrawer(a.character, i),
            M.addShapeDrawer(a.image, e),
            M.addShapeDrawer(a.images, e)
        }
        init() {
        ...
        loadJSON(t, i, e) {
          return Di.loadJSON(t, i, e)
        }
        setOnClickHandler(t) {
          Di.setOnClickHandler(t)
        }
        dom() {
          return Di.dom()
        }
        ...
        constructor() {
          super(), this.addPlugin(qi), this.addPlugin(Xi), this.addPlugin(ne)
        }
      })()
      ae.init()
      const { particlesJS: re, pJSDom: le } = ((t) => {
